...
type Props = {
  ...
  setIsPlaceInputVisible: (visible: boolean) => void;
};

const PhotoVideoModal = ({
  deceasedUser,
  handleCancelFileInput,
  isLoading,
  isPlaceInputVisible,
  setIsPlaceInputVisible,
      ...
      <DialogDescription className="space-y-4">
        ...
        {isPlaceInputVisible ? (
          ...
          <Button
            ...
            type="button"
            onClick={() => setIsPlaceInputVisible(true)}
          >
            <Camera size={18} />
            <span>Add a location associated with this photo</span>
          </Button>
        )}
...
export default PhotoVideoModal;
